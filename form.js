...
function validateForm() {
  const validation = checkUsername(userNameInput.value) && checkContrasena(contrasenaInput.value) && checkRespuestaSeg(respuestaSeguridadInput.value) && checkPreguntaSeg(preguntaSeguridadInput.value);
  return validation;
}
